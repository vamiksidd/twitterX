...
import { XSvg } from "../../../components/components";
    ...
    <div className="max-w-screen-xl mx-auto flex h-screen">
      ...
      <div className="flex-1 flex flex-col justify-center items-center">
        <form className="flex gap-4 flex-col w-80" onSubmit={handleSubmit}>
          ...
          <label className="input input-bordered  rounded flex items-center gap-5">
            <MdOutlineMail />
            <input
              type="text"
              className="grow"
          ...
          <label className="input input-bordered  rounded-sm flex items-center gap-5">
            <MdPassword />
            <input
              type="password"
              className="grow"
